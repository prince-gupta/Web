...
<body>
	...
	<div class="container" >
		...
		<table class="table table-hover"  style="display: none" id="resultTable">
			<thead>
				<tr>
					<th>#</th>
					<th>Firstname</th>
		...
		<div id="myModal" class="modal fade " role="dialog">
			<div class="modal-dialog modal-sm">
				...
				<div class="modal-content">
					<div class="modal-header bgRoyalBlue">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default borderRadius20px" data-dismiss="modal">Close</button>
					</div>
				</div>
